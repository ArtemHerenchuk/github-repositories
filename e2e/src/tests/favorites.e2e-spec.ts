...
describe('Favorites', () => {
  ...
  it('check favorites', () => {
    ...
    const expectedRepoName = 'vereniaTestTaskRepoName3be2c944-6372-4d2f-91d5-3356c52bed67';
    new LocalStorage().setItem('favorites', favorites);
    page.navigateTo();
    expect(page.repoNames.first().getText()).toEqual(expectedRepoName);
  });
  ...
  it('check favorites1', () => {
    ...
    expect(page.repoNames.first().getText()).toEqual('vereniaTestTaskRepoName3be2c944-6372-4d2f-91d5-3356c52bed67');
  });
